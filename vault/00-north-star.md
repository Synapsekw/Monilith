...
- **Branch:** `develop` (**ahead of `origin/develop` by 20, 0 behind** — 5c-1's run-history commits + the name-column work + the 5c-1 dropdown-shape fix; nothing pushed this session). `main` at squash commit `30a9cf3` — **do not promote yet** (WebGL landing dep needs a manual cross-browser check; develop also carries unpushed 5c-1 + name-column work).
