...
- **2 — Boards core** — <span style="color:#fdab3d">**[2a+2b Done — 2c next]**</span>
...
- **Phase:** **Phase 4 Collaboration complete (4a+4b+4c)** + public landing shipped; **now building Phase 2c — column management** (add/rename/delete/resize — the missing boards-core column CRUD; spec [[2026-06-17-phase-2c-column-management-design]]). Then {`develop → main` promotion, light-mode reskin, Dashboard view, Phase 5 Automations}
