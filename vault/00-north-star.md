...
- **Phase:** Phase 6 (ClickUp depth) in progress — **6a + 6b + 6c shipped + pushed**. **Next: 6d — relations + mirror** · 6e docs. Full phase status above in §2 "Where we are". Cross-cutting **board-level sharing** spec+plan now ready to build (see Latest below).
