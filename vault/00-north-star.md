...
- **5 — Automations + Rules** — <span style="color:#eab308">**[In progress — 5a done]**</span>
  ...
  [[2026-06-18-phase-5a-automations-design]]; see [[2026-06-18-1711-phase5a-automations]]. **5b** next:
  more triggers/actions + the "If" condition; **5c**: Edge-Function external actions + run history._
