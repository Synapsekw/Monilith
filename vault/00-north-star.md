...
- **Phase:** Phase 6 (ClickUp depth) in progress — **6a Subitems + 6b Custom fields/statuses shipped; 6c time tracking specced + planned (not built)**. **Next: build 6c** (execute the plan), then D relations+mirror · E docs. Full phase status above in §2 "Where we are".
