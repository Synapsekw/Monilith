...
- **In flight:** nothing open. Last edit: **Kanban card polish (Direction A)** ([[2026-06-24-1901-kanban-card-polish]]) — sunken lanes / raised cards, 2-line titles, status-pill + icon meta footer, dynamic card virtualization; built in a worktree + merged. Also confirmed the reported "17 items with no state" is correct data (16 parent rows + 1 subitem lack a `Stage` value), not a Kanban bug. No task worktrees active.
