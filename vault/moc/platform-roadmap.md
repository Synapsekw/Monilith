...
| 6   | ClickUp depth                      | Subitems/nesting, time tracking, Docs, custom statuses/fields, relations + mirror, real-time collab (presence)                                                                                                | **In progress** (6a–6g done; 6h presence planned; 6e Docs deferred) |
