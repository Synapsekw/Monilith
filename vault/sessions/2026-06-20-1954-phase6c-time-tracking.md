...
- Resolved a pre-existing **migration-ledger drift** via `migration repair` ([[2026-06-21-1037-migration-ledger-drift-fix]]) and two plan-vs-repo traps (PascalCase commit subject; `Date.now()`-in-render purity rule).
