...
-- CREATE OR REPLACE only — no schema/type change. Body copied verbatim from
-- 20260619130000_automations_5c2_webhook_schema.sql with one added branch
-- (move_to_group) and its outcome recorded in the run ledger like the others.
