    ...
    <div className="space-y-4">
      ...
      >
        ...
        <select
          ...
          className={cn(
            "border-border bg-background text-foreground hover:bg-state-hover hover:border-border-hover focus-visible:ring-ring/50 focus-visible:border-ring h-9 rounded-md border px-3 text-sm capitalize transition-colors",
